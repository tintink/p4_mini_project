...
```{r fig.height=6, fig.width=10, message=FALSE}
ggsave("p4_plots/covid_mortality_rates_plot.png", covid_mortality_rates_plot,width = 10, height = 6, dpi=200)
ggsave("p4_plots/mortality_rate_comparison_plot.png", mortality_rate_comparison_plot,width = 10, height = 6, dpi=200)
ggsave("p4_plots/total_deaths_comparison_plot.png", total_deaths_comparison_plot,width = 10, height = 6, dpi=200)
ggsave("p4_plots/new_rtt_period_plot.png", new_rtt_period_plot,width = 10, height = 6, dpi=100)
ggsave("p4_plots/total_deaths_plot_G7.png", total_deaths_plot_G7,width = 10, height = 6, dpi=200)
```
```
